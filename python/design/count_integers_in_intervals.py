...
https://leetcode.com/problems/count-integers-in-intervals/description/?envType=company&envId=linkedin&favoriteSlug=linkedin-thirty-days
...
class CountIntervals:
    ...
    def add(self, left: int, right: int) -> None:
        idx = bisect_left(self.ranges, [left, right])
        ...
        while idx + 1 < len(self.ranges) and self.ranges[idx + 1][0] <= right:
