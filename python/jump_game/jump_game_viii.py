...
class Solution:
    def minCost(self, nums: List[int], costs: List[int]) -> int:
        ...
        # use descreasing monotonic stack to look for the first greater element than the current number
        # use increasing monotonic stack to look for the first smaller element than the current number
